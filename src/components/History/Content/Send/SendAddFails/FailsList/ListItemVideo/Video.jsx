...
function Video(props) {
  ...
  return (
    <div className={style.block}>
      <ReactPlayer width={200} height={150} url={url} controls />
      <div className={style.remove} onClick={() => props.handleDeleteFail(props.video.id, "video", props.amount, props.groupId)}>
