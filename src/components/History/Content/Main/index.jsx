...
import { addMasterRole, deleteMasterRole, getMasterRole } from '../../../../redux/ducks/user';
...
function Main() {
  ...
  return (
    <div className={style.main}>
     <input onChange={changeRoleMaster} checked={master} className={style.input} type="checkbox" name="switch" id="switch" />
