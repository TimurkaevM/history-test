...
function Material(props) {
  return (
    <div className={style.material}>
      <div className={`${style.material__logo} ${props.material.status === "В обработке" ? style.blue : ""} ${props.material.status === "Обработано" ? style.green : ""}`}>
      ...
      <div className={`${style.material__status} ${props.material.status === "В обработке" ? style.blue : ""} ${props.material.status === "Обработано" ? style.green : ""}`}>
